package com.designer_two.mp.generator;
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "C:\\ws\\java\\92DesignerJava";
        ...
        dsc.setUrl("jdbc:mysql://148.70.61.158:3306/92sj?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=UTF-8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("yu1596321");
        ...
        pc.setParent(null);
        // 这个地址是生成的配置文件的包路径
        pc.setEntity("com.designer_two.mp.entity");

        //pc.setController("com.cikers.ps.controller");
        pc.setMapper("com.designer_two.mp.mapper");
